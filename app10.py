...
def main():
    ...
    #유저가 선택한 언어만 차프로 표시하려 한다

    print(df.columns[1:])

    continu_menu=df.columns[1:]
    choice_list=st.multiselect('언어를 선택',continu_menu)
    print(choice_list)
    ...
    if len(choice_list)!=0:
        ...
        ###2017년 4월부터 2018년 3월까지의 데이터를 바차트로 나타네시오
